...
class LineNumberWidget(tk.Canvas):
    ...
    def aktualisiere_zeilennummer(self, *args):
        '''Die Zeilennummern werden jedes mal aufs Neue auf das Canvas gemalt'''
        self.delete("all")
...
class TextWidget(tk.Text):
    """Diese Klasse erstellt ein <<Change>>-Event
    wenn der Text bearbeitet wird oder gescrollt wird."""
    def __init__(self, *args, **kwargs):
    ...
    def _proxy(self, *args):
        ...
        # Returnen was im Widget passiert ist.
        print(result)
        return result


class Zusammengesetzt(tk.Frame):
    """Setzt in einem Frame die Zeilennummern-Canvas und das Eingabe-Textfeld zusammen."""
    def __init__(self, *args, **kwargs):
        tk.Frame.__init__(self, *args, **kwargs)
        self.text = TextWidget(self)
        self.scrollbar = tk.Scrollbar(self, orient="vertical", command=self.text.yview)
        self.text.configure(yscrollcommand=self.scrollbar.set)
        self.text.tag_configure("bigfont", font=("Helvetica", "24", "bold"))
        self.linenumbers = LineNumberWidget(self, width=30)
    ...
    def _on_change(self, event):
        self.linenumbers.aktualisiere_zeilennummer()
...
class Textframe(ttk.Frame):
    def __init__(self, master=None):
        ...
        self.textfeld_rechts = tk.Text(self, wrap=tk.WORD, width=40, height=10, font=("Helvetica", 14))
...
class GUI:
    def __init__(self, modell):
        ...
        self.file_menu.add_command(label="Open", command=self.laden)
        self.file_menu.add_command(label="Save as...", command=self.save_as)

        self.menu.add_cascade(label="File", menu=self.file_menu)

        # self.menu.add_cascade(label="Open", menu=self.file_menu)
        ...
        self.textf2 = Zusammengesetzt(self.window)
        self.textf2.grid(row=0, column=0, rowspan=7, sticky="nsew")
        ...
        self.ausfuehren_button = tk.Button(self.window, text="Ausführen", command=self.ausfuehren)
        self.ausfuehren_button.grid(row=7, column=0, sticky="ew", padx=20, pady=20)
    ...
    def save_as(self):
        ...
        dict_temp = self.string_to_dict(self.textf2.text.get("1.0", tk.END))
    ...
    def laden(self):
        ...
        self.textf2.text.delete("1.0", tk.END)
        zeilen_dict = {}
        ...
        for i in range(1, max_zeilennummer + 1):
            ...
            self.textf2.text.insert(tk.END, f"{text}\n")
        self.textf2.linenumbers.aktualisiere_zeilennummer()
        # self.label_update()
